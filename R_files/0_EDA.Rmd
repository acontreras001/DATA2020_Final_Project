...
# Numeric Variables
numeric_vars <- c("cf3age", "f3l1")

# Race variables of Respondent - variables are one hot encoded
race_vars <- c("r3f13_0", "r3f13_1", "r3f13_2", "r3f13_3", "r3f13_4", "r3f13_5", "r3f13_9", "r3f14", "r3f15")

# Binary Variables
binary_vars <- c("f3e5a", "cf3marm", "cf3cohm", "m3i0i", "m3i0j")
